...
from apprentice.solver.techniques.naked_single import (
    find_naked_single, justifies_naked_single,
)
from apprentice.solver.techniques.hidden_single import (
    find_hidden_single, justifies_hidden_single,
)
from apprentice.solver.techniques.naked_pair import (
    find_naked_pair_elimination, justifies_naked_pair,
)
from apprentice.solver.techniques.hidden_pair import (
    find_hidden_pair_elimination, justifies_hidden_pair,
)
from apprentice.solver.techniques.pointing_pair import (
    find_pointing_pair_elimination, justifies_pointing_pair,
)
from apprentice.solver.techniques.box_line import (
    find_box_line_elimination, justifies_box_line,
)
from apprentice.solver.techniques.naked_triple import (
    find_naked_triple_elimination, justifies_naked_triple,
)
from apprentice.solver.techniques.naked_quad import (
    find_naked_quad_elimination, justifies_naked_quad,
)
from apprentice.solver.techniques.x_wing import (
    find_x_wing_elimination, justifies_x_wing,
)
from apprentice.solver.techniques.swordfish import (
    find_swordfish_elimination, justifies_swordfish,
)
from apprentice.solver.techniques.xy_wing import (
    find_xy_wing_elimination, justifies_xy_wing,
)
from apprentice.solver.techniques.xyz_wing import (
    find_xyz_wing_elimination, justifies_xyz_wing,
)
from apprentice.solver.techniques.trial_error import (
