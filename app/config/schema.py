...
CONFIG_SCHEMA: dict[str, dict] = {
    ...
    "training.mrv_mix_prob": {
        ...
        "max": 1.0,
        "reload_required": True,
        "description": "訓練初期使用 MRV 專家示範的機率",
    },
    "training.mrv_decay_steps": {
        ...
        "max": 500000,
        "reload_required": True,
        "description": "MRV 混合率從初始值衰減到最小值所需的步數",
    },
    ...
    "proxy.max_rotations": {
        ...
        "max": 100,
        "reload_required": False,
        "description": "單次抓題失敗後最多嘗試切換幾個 Proxy",
    },
    "proxy.validate": {
        "label": "啟動時驗證 Proxy",
        "category": "proxy",
    ...
    "crawler.puzzle_ready_timeout_ms": {
        ...
        "max": 60000,
        "reload_required": False,
        "description": "等待 puzzle_grid 出現的最長時間（毫秒）",
    },
    "crawler.puzzle_ready_poll_ms": {
        ...
        "max": 5000,
        "reload_required": False,
        "description": "檢查 puzzle_grid 是否就緒的輪詢間隔（毫秒）",
    },
